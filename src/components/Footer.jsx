...
function Footer() {
  return (
    <div className="w-full h-screen font-['Neue_Montreal'] flex gap-5 bg-zinc-900 pt-20 px-20 ">
      ...
      <div className="w-1/2">
        <h1 className="text-[6.8vw] font-semibold uppercase leading-none tracking-tighter -mb-5">
          Presentations
        </h1>
        <div className="mt-5">
        ...
        <div className="location  w-full mt-5 flex items-center justify-between">
          <div className="w-1/2  flex flex-col items-start">
            <div>
              <h1 className="text-xl my-6">L:</h1>
              {[
                "202-1965 W 4th Ave",
                "Vancouver, Canada",
                "30 Chukarina St",
          ...
          <div className="w-1/2  flex flex-col items-end">
            <div>
              <h1 className="text-xl my-6">M:</h1>
              {[
                "Services",
                "Our work",
                "About us",
        ...
        <div className="email w-full mt-5">
          <h1 className="text-xl my-5">E:</h1>
          <a href="#">hello@ochi.design</a>
        </div>
        <div className="last w-full flex justify-between mt-5 ">
          <h1 className="text-xl text-zinc-700">
            © ochi design 2024. Legal Terms
          </h1>
          <h1 className="text-xl text-zinc-700">Website by Obys</h1>
        </div>
      </div>
    </div>
  );
